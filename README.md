...
```shell
cd modules
git clone https://github.com/only-devices/MMM-Carousel
```
...
| `skipEmptyModules`                                                                                                                                                                | If a given module is empty, skip it. This is useful for dynamic modules like MMM-MyScoreboard, which may not display content on some days of the week. This value is **OPTIONAL**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
